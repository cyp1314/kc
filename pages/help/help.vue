<template>
	<view class="wrap content">
		<u-navbar :is-back="false" :is-fixed="true" :border-bottom="false" title="资源共享" :background="background"></u-navbar>
		<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
			<u-form-item :label-position="labelPosition" label="方式" prop="type" label-width="150">
				<u-radio-group v-model="radio" @change="radioGroupChange" :width="radioCheckWidth" :wrap="radioCheckWrap">
					<u-radio shape="circle" v-for="(item, index) in typeList" :key="index" :name="item.name">{{ item.name }}</u-radio>
				</u-radio-group>
			</u-form-item>
			<u-form-item :label-position="labelPosition" label="邮箱" prop="name">
				<u-input :border="border" placeholder="请输入联系邮箱" v-model="model.name" type="text"></u-input>
			</u-form-item>
			<u-form-item :label-position="labelPosition" label="名称" prop="intro">
				<u-input type="textarea" :border="border" placeholder="请填写资源教程或书籍名称" v-model="model.intro" />
			</u-form-item>
			<u-form-item :label-position="labelPosition" label="地址" prop="intro">
				<u-input type="textarea" :border="border" placeholder="请填写资源教程或书籍网盘地址及密码" v-model="model.intro" />
			</u-form-item>
			...
			<u-form-item :label-position="labelPosition" label="平台类型" prop="goodsType" label-width="150">
