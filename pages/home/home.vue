<template>
	<view class="content">
		...
		<view class="wrap"><u-swiper :height="260" :list="list" mode="dot" :effect3d="true" bg-color="#fff" :title="true"></u-swiper></view>
		<view class="notice-bar"><u-notice-bar mode="horizontal" :is-circular="false" :list="notices"></u-notice-bar></view>
		...
		<!-- <scroll-view style="height: 1200px;" scroll-y="true" refresher-enabled="true" :refresher-triggered="triggered"
